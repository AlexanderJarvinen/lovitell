        ...
        <div class="col-lg-12">
            ...
            <div class="tab-content">
                ...
                <div id="equipment" class="tab-pane fade <?php if($first_tab){$first_tab=false;echo 'in active';}?>">
                    <h3>Оборудование <a href="/inventory/building/{{$build['address_id']}}/export"><i class="fa fa-download"></i></a></h3>
                            @if(isset($equipment['max_floor']) && isset($equipment['min_floor']))
                                                        ...
                                                        @if(isset($entr['loft']))
                                                            <td class="loft">
                                                                @foreach($entr['loft']['devices'] as $dev)
                                                                    @if ($dev['source'] != '')
                                                                        <span class="state{{$dev['state']}} route system system{{$dev['system']}} situation{{$dev['situation']}}" data-name="{{$dev['route']}}"></span><&#8209;<span class="state{{$dev['source_state']}} route system system{{$dev['source_system']}}" data-name="{{$dev['source']}}"><span class="port" data-child="{{$dev['route']}}">({{$dev['port']}})</span></span><br>
                                                                    @else
                                                                        <span class="state{{$dev['state']}} route system system{{$dev['system']}} situation{{$dev['situation']}}" data-name="{{$dev['route']}}"></span><br>
                                                                    @endif
                                                                @endforeach
                                                            </td>
                                                        @else
                                ...
                                <div class="equipment_legend">
                                    ...
                                    <ul class="equipment_legend__list-state after_revision" style="display: none;">
                                        ...
                                        <li class="system system-3 state0 situation0 check-error-31">При сверке выявлены ошибки</li>
                                    </ul>
                                    <div class="clearfix"></div>
                                </div>
                                @if (isset($equipment['additional']))
                                    ...
                                    @foreach($equipment['additional']['devices'] as $dev)
                                        @if ($dev['source'] != '')
                                            <span class="state{{$dev['state']}} route system system{{$dev['system']}}" data-name="{{$dev['route']}}"></span><&#8209;<span class="state{{$dev['source_state']}} route system system{{$dev['source_system']}}" data-name="{{$dev['source']}}"><span class="port" data-child="{{$dev['route']}}">({{$dev['port']}})</span></span>;
                                        @else
                                            <span class="state{{$dev['state']}} route system system{{$dev['system']}}" data-name="{{$dev['route']}}"></span>;
                                        @endif
                                    @endforeach
                                @endif
