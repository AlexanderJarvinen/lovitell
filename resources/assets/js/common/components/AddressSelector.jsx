...
var AddressSelector = React.createClass({
    ...
    componentDidMount: function() {
        console.log('Address np did mount');
    ...
    componentWillReceiveProps: function(np) {
        if (np.address_id != this.props.address_id && np.address_id != this.state.address_id) {
            this.setState({
                city_id: np.city_id,
                region_id: np.region_id,
    ...
    AddressIdChange: function(address) {
        console.log(address);
        this.setState({
            address_id: address.id || address,
            construction_type: address.construction_type || 1
        },
        this.AddressChange);
    },
