...
import AddressSelectorAutocomplete from '../../common/components/AddressSelectorAutocomplete';
...
var ClientList = React.createClass({
    ...
    handleInbuildChange: function(address) {
        this.setState({
