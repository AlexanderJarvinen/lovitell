...
$table .= "</table>";
    ...
    //if ($_COOKIE["login"] == 'mj'){
	echo "<img src=\"../images/file_xls_excel.png\">&nbsp;&nbsp;";
	if (isset($_GET['date1']) and isset($_GET['date2'])){
	    echo "<a href=\"ajax/export.php?id=".$_GET['id']."&date1=".$_GET['date1']."&date2=".$_GET['date2']."\">Экспорт</a><br>";
	} else {
	    echo "<a href=\"ajax/export.php?id=".$_GET['id']."\">Экспорт</a><br>";
	}
    //}
