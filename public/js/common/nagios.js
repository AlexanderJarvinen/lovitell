...
/***/ function(module, exports, __webpack_require__) {
	...
	var NagiosCrashesTable = React.createClass({
	    ...
	    getColumns: function getColumns() {
	        return [{
	            ...
	            cell: {
	                formatters: [function (route, row) {
	                    return React.createElement(
	                        'span',
	                        { className: 'system system' + row.rowData.system },
	                        route
	                    );
	                }]
	            }
	    ...
	    handleFlapsInfo: function handleFlapsInfo(a) {
	        if (a.error == 0) {
	            this.setState({
	                items: a.data
	            });
	    ...
	    getCrashesInfo: function getCrashesInfo() {
	        $.ajax({
	            method: "GET",
	    ...
	    onRow: function onRow(row, rowIndex) {
	        return {
	    ...
	    render: function render() {
	        return React.createElement(
	            'div',
	            { className: 'col-md-6 col-sm-12 nagios-table__wrap' },
	            React.createElement(
	                'div',
	                { className: 'box' },
	                React.createElement(
	...
	var NagiosFlapsTable = React.createClass({
	    ...
	    getFlapsInfo: function getFlapsInfo() {
	        $.ajax({
	            method: "GET",
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        'h3',
	                        null,
	                        '\u041A\u043E\u043B\u0438\u0447\u0435\u0441\u0442\u0432\u043E \u0432\u043A\u043B\u044E\u0447\u0435\u043D\u0438\u0439/\u043E\u0442\u043A\u043B\u044E\u0447\u0435\u043D\u0438\u0439 \u0437\u0430 \u043F\u043E\u0441\u043B\u0435\u0434\u043D\u0438\u0435 24 \u0447\u0430\u0441\u0430 (30 \u0445\u0443\u0434\u0448\u0438\u0445)'
	                    )
	                ),
	                React.createElement(
	                    'div',
	                            ...
	                            React.createElement(
	                                'select',
	                                {
	                                    ...
	                                    onChange: function onChange(e) {
	                                        _this.setState({ type: e.target.value }, _this.getFlapsInfo);
	                                    } },
	...
	var NagiosPage = React.createClass({
	    displayName: 'NagiosPage',

	    render: function render() {
	        return React.createElement(
	            'div',
	            { className: 'row' },
	            React.createElement(NagiosCrashesTable, null),
	            React.createElement(NagiosFlapsTable, {
	...
	ReactDOM.render(React.createElement(NagiosPage, {
