...
/***/ function(module, exports, __webpack_require__) {
	...
	var NetworkCheck = React.createClass({
	    ...
	    handleSuccessNetworkCheck: function handleSuccessNetworkCheck(data) {
	        console.log(data);
	        if (data.error != 0) {
	            var total = 0;
	            var ok = 0;
	            ...
	            for (var route in data) {
	                ...
	                var r = $('.route[data-name=' + data[route].name.replace(/\./g, "\\.") + ']');
	                ...
	                if (data[route].error == 0) {
	                    ...
	                    $('.port[data-child=' + data[route].name.replace(/\./g, "\\.") + ']').attr('data-port-status', 'Up');
	                    r.attr('data-emsg', '').attr('data-error', 0).attr('data-port', 'Up').attr('data-ping', 'Ok').attr('data-macs', '');
	                } else {
	                    error++;
	                    if (data[route].system == -3) {
	                        ap_error++;
	                    ...
	                    $('.route[data-name=' + data[route].name.replace(/\./g, "\\.") + ']').removeClass('check-ok').addClass('check-error').attr('data-emsg', data[route].msg).attr('data-ping', data[route].ping).attr('data-error', data[route].error).attr('data-port', data[route].port_status).attr('data-macs', data[route].ports);
	    ...
	    startNetworkCheck: function startNetworkCheck() {
	        this.setState({
	            total: 0,
	            ok: 0,
	            error: 0
	    ...
	    acceptNcc: function acceptNcc(system, e) {
	    ...
	    render: function render() {
	        ...
	        if (this.state.ap_total) {
	            ap_result = React.createElement(
	                'div',
	                { className: 'system_result' },
	                'AP ',
	                React.createElement(
	                    'span',
	                    { className: 'revision_total' },
	                    '\u0432\u0441\u0435\u0433\u043E: ',
	                    this.state.ap_total
	                ),
	                ' ',
	        ...
	        if (this.state.cam_total) {
	            cam_result = React.createElement(
	                'div',
	                { className: 'system_result' },
	                'CAM ',
	                React.createElement(
	        ...
	        if (this.state.apo_total) {
	            apo_result = React.createElement(
	                'div',
	                { className: 'system_result' },
	                'APO ',
	                React.createElement(
	        ...
	        if (this.state.ap_error == 0 && this.state.ap_total != 0 && this.props.can_accept) {
	            accept_btn = React.createElement(
	                'button',
	                { className: 'btn btn-primary', onClick: this.acceptNcc.bind(null, -3) },
	                '\u041F\u0440\u0438\u043D\u044F\u0442\u044C \u0432\u043D\u0443\u0442\u0440\u0435\u043D\u043D\u0438\u0435 \u0422\u0414'
	            );
	        }
	        var accept_apo_btn = null;
	        if (this.state.apo_error == 0 && this.state.apo_total != 0 && this.props.can_accept) {
	            accept_apo_btn = React.createElement(
	                'button',
	                { className: 'btn btn-primary', onClick: this.acceptNcc.bind(null, 11) },
	                '\u041F\u0440\u0438\u043D\u044F\u0442\u044C \u0432\u043D\u0435\u0448\u043D\u0438\u0435 \u0422\u0414'
	            );
	        }
	        var accept_cam_btn = null;
	        if (this.state.cam_error == 0 && this.state.cam_total != 0 && this.props.can_accept) {
	            accept_cam_btn = React.createElement(
	                'button',
	                { className: 'btn btn-primary', onClick: this.acceptNcc.bind(null, -4) },
	                '\u041F\u0440\u0438\u043D\u044F\u0442\u044C \u043A\u0430\u043C\u0435\u0440\u044B'
	            );
	        }
	        return React.createElement(
	            'div',
	            { className: 'network_check wrap' },
	            React.createElement(
	                'h3',
	                null,
	                '\u0421\u0432\u0435\u0440\u043A\u0430 Inventory \u0438 \u0441\u0435\u0442\u0438'
	            ),
	            React.createElement(
	                'div',
	                null,
	                React.createElement(
	                    'button',
	                    { className: 'btn btn-default', onClick: this.startNetworkCheck },
	                    '\u0417\u0430\u043F\u0443\u0441\u0442\u0438\u0442\u044C \u0441\u0432\u0435\u0440\u043A\u0443'
	                )
	            ),
	            React.createElement(
	                ...
	                React.createElement(
	                    'a',
	                    { href: '/inventory/check-network/' + this.props.address_id + '/export' },
	                    '\u0421\u043A\u0430\u0447\u0430\u0442\u044C \u043A\u0430\u043A \u0444\u0430\u0439\u043B'
	                )
	            ),
	            React.createElement(
	                'div',
	                { className: 'accept__wrap' },
	                accept_btn,
	                ' ',
	                accept_apo_btn,
	                ' ',
	...
	ReactDOM.render(React.createElement(NetworkCheck, {
