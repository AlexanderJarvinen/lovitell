...
/***/ function(module, exports, __webpack_require__) {
	...
	var WidgetContainer = __webpack_require__(904);
	var WidgetStore = __webpack_require__(870);
	var DashboardStore = __webpack_require__(905);
	    ...
	    render: function render() {
	        ...
	        if (this.state.is_changed) {
	            buttons = React.createElement(
	                ...
	                React.createElement(
	                    'button',
	                    { className: 'btn btn-primary btn-md', onClick: this._saveHandler },
	                    '\u0421\u043E\u0445\u0440\u0430\u043D\u0438\u0442\u044C'
	                ),
	                React.createElement(
	                    'button',
	                    { className: 'btn btn-danger btn-md', onClick: this._resetHandler },
	                    '\u041E\u0442\u043C\u0435\u043D\u0438\u0442\u044C'
	                )
	            );
	        }
	        if (this.state.isinit) {
	            for (var widget_id in widgets) {
	                cwidgets.push(React.createElement(WidgetContainer, {
	                    id: widget_id,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactChartjs = __webpack_require__(819);
	...
	var GraphWidget = React.createClass({
	    ...
	    makeBarData: function makeBarData(a) {
	        var data = {};
	        data['labels'] = a.labels;
	        data['datasets'] = [];
	        for (var i in a.datasets) {
	            data['datasets'].push({
	        ...
	        var max = Math.max.apply(null, a.datasets[0].data);
	        var min = a.type == 'pieces' ? 0 : Math.min.apply(null, a.datasets[0].data);
	        var step = (max - min) / 10 || a.type == 'percent' ? 1 : 10;
	        step = a.type == 'pieces' ? parseInt(step) : step;
	        this.setState({ data: data, max: max, min: min, step: step, type: a.type });
	    },
	    makeLineData: function makeLineData(a) {
	        var data = a;
	        for (var i in data.datasets) {
	            var bc = data.datasets[i].borderColor;
	        ...
	        this.setState({ data: data, type: a.type || 'pieces' });
	    },
	    makeData: function makeData(a) {
	    ...
	    render: function render() {
	        ...
	        switch (this.props.type) {
	            case GRAPH_BAR:
	                Element = React.createElement(_reactChartjs.Bar, {
	            ...
	            case GRAPH_LINE:
	                ...
	                Element = React.createElement(_reactChartjs.Line, {
	                    data: this.state.data,
	                    options: {
	                        events: false,
	                        tooltips: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _chart = __webpack_require__(820);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * @namespace Chart
	 */
	var Chart = __webpack_require__(821)();

	__webpack_require__(822)(Chart);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var color = __webpack_require__(823);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* MIT license */
	var convert = __webpack_require__(824);
	var string = __webpack_require__(826);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var conversions = __webpack_require__(825);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* MIT license */
	var colorNames = __webpack_require__(827);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var implementation = __webpack_require__(829);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }()), __webpack_require__(468)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDom = __webpack_require__(162);
	var classNames = __webpack_require__(133);
	var WidgetLoading = __webpack_require__(906);
	var GraphWidget = __webpack_require__(818);
	...
	var width = ['', 'col-md-1', 'col-md-2', 'col-md-3', 'col-md-4', 'col-md-5', 'col-md-6', 'col-md-7', 'col-md-8', 'col-md-9', 'col-md-10', 'col-md-11', 'col-md-12'];

	var offset = ['', 'col-md-offset-1', 'col-md-offset-2', 'col-md-offset-3', 'col-md-offset-4', 'col-md-offset-5', 'col-md-offset-6', 'col-md-offset-7', 'col-md-offset-8', 'col-md-offset-9', 'col-md-offset-10', 'col-md-offset-11', 'col-md-offset-12'];
	...
	var WidgetContainer = React.createClass({
	    ...
	    getInitialState: function getInitialState() {
	        ...
	        var height = this.props.height || 250;
	        if (this.props.resize.indexOf(':') != -1) {
	            console.log('Content');
	            var ratio_list = this.props.resize.split(':');
	    ...
	    onMouseMoveResize: function onMouseMoveResize(e) {
	    ...
	    onMouseMoveDragging: function onMouseMoveDragging(e) {
	    ...
	    updateDimensions: function updateDimensions() {
	        if (this.state.resize_ratio != 0) {
	            var dn = ReactDOM.findDOMNode(this);
	            var w = dn.offsetWidth;
	            var h = w * this.state.resize_ratio;
	            this.setState({
	    ...
	    render: function render() {
	        var widget_box_class = classNames('box', 'box-primary', { 'collapsed-box': this.state.collapse == true }, { 'resize-ratio': this.props.resize.indexOf(':') });
	        var widget_class = classNames(width[this.state.width], offset[this.state.offset], 'dashboard_widget');
	        ...
	        var content_comp = null;
	        if (is_component) {
	            var Element = Widgets[content.component];
	            content_comp = React.createElement(
	                'div',
	                { className: 'box-body', style: { height: this.state.height - 50 + 'px' } },
	                React.createElement(Element, content.props)
	            );
	        } else {
	            content_comp = React.createElement('div', { className: 'box-body', style: { height: this.state.height - 50 + 'px' }, dangerouslySetInnerHTML: { __html: content } });
	        }
	        return React.createElement(
	            'div',
	            ...
	            React.createElement(
	                'div',
	                { className: widget_box_class,
	                    style: { height: this.state.collapse || this.state.height == 0 ? 'auto' : this.state.height + 'px' }
	                },
	                React.createElement(
	                    'div',
	                    { className: 'box-header with-border dragg-handler', onMouseDown: this.dragging },
	                    React.createElement(
	                        'h4',
	                        { className: 'box-title' },
	                        this.props.title
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            'button',
	                            { type: 'button', className: 'btn btn-box-tool', onMouseDown: this.stop, onClick: this.handleCollapse },
	                            React.createElement('i', { className: 'fa fa-minus' })
	                        ),
	                        React.createElement(
	                            'button',
	                            { type: 'button', className: 'btn btn-box-tool', onMouseDown: this.stop, onClick: this.handleRemove },
	            ...
	            React.createElement('span', { className: 'resize-handler', onMouseDown: this.resize })
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DashboardStore = assign({}, EventEmitter.prototype, {
	    ...
	    saveWidgets: function saveWidgets() {
	    ...
	    resize: function resize(widget_id, width, height) {
	    ...
	    init: function init(dashboard_id, kit_id) {
	        _widget_store.dashboard_id = dashboard_id;
	        _widget_store.kit_id = kit_id || 0;
	        _reset();
	    },

	    dragOnWidget: function dragOnWidget(widget_id) {
	    ...
	    removeWidget: function removeWidget(widget_id) {
	        _delete(widget_id);
	        _widget_store.ischanged = true;
	        this.emit(CHANGE_EVENT);
	    },

	    collapseWidget: function collapseWidget(widget_id, collapse) {
	        _widget_store.ischanged = true;
	     ...
	     * @param {function} callback
	     */
	    addDragStartListener: function addDragStartListener(callback) {
	     ...
	     * @param {function} callback
	     */
	    removeDragStartListener: function removeDragStartListener(callback) {
	     ...
	     * @param {function} callback
	     */
	    addDragStopListener: function addDragStopListener(callback) {
	     ...
	     * @param {function} callback
	     */
	    removeDragStopListener: function removeDragStopListener(callback) {
