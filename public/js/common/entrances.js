...
/***/ function(module, exports, __webpack_require__) {
	...
	var Entrances = React.createClass({
	    ...
	    loadEntrances: function loadEntrances() {
	        $.ajax({
	            type: "GET",
	    ...
	    loadEntrancesSuccess: function loadEntrancesSuccess(a) {
	        var data = [];
	        for (var k in a) {
	            data[k] = {
	                floors: a[k].floors,
	    ...
	    deleteEntrance: function deleteEntrance(entrance_id) {
	        var data = this.state.entrances;
	        data[entrance_id].deleted = 1;
	        this.setState({ entrances: data, is_changed: 1 });
	    },
	    entranceChange: function entranceChange(entrance_id, e) {
	        var data = this.state.entrances;
	        data[entrance_id].floors = e.target.value;
	        data[entrance_id].is_changed = 1;
	        this.setState({ entrances: data, is_changed: 1 });
	    },
	    entranceInteriorChange: function entranceInteriorChange(entrance_id, e) {
	        var data = this.state.entrances;
	        data[entrance_id].interior = e.target.checked ? 1 : 0;
	        data[entrance_id].is_changed = 1;
	        this.setState({ entrances: data, is_changed: 1 });
	    },
	    addEntrance: function addEntrance() {
	        var data = this.state.entrances;
	    ...
	    makeTableContent: function makeTableContent() {
	        var data = this.state.entrances;
	        var resp = [];
	        for (var k in data) {
	            ...
	            resp.push(React.createElement(
	                ...
	                React.createElement(
	                    'td',
	                    null,
	                    React.createElement('input', { className: 'entrance-num', value: data[k].floors, onChange: this.entranceChange.bind(null, k) })
	                ),
	                React.createElement(
	                    'td',
	                    null,
	                    React.createElement('input', { type: 'checkbox', checked: data[k].interior, onChange: this.entranceInteriorChange.bind(null, k) })
	                ),
	                React.createElement(
	                    'td',
	                    null,
	                    React.createElement('i', { className: 'fa fa-times link', onClick: this.deleteEntrance.bind(null, k) })
	                )
	            ));
	        }
	        if (resp.length == 0) {
	    ...
	    render: function render() {
	        ...
	        if (this.state.is_changed) {
	            buttons = React.createElement(
	                ...
	                React.createElement(
	                    'button',
	                    { className: 'btn btn-primary btn-md', onClick: this.saveHandler },
	                    '\u0421\u043E\u0445\u0440\u0430\u043D\u0438\u0442\u044C'
	                ),
	                React.createElement(
	                    'button',
	                    { className: 'btn btn-danger btn-md', onClick: this.resetHandler },
	                    '\u041E\u0442\u043C\u0435\u043D\u0438\u0442\u044C'
	                )
	            );
	        }
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            ...
	                            React.createElement('input', {
	                                ...
	                                onChange: function onChange(e) {
	                                    _this.setState({ new_entr_id: e.target.value });
	                                }
	                            })
	                        ),
	                        React.createElement(
	                            ...
	                            React.createElement('input', {
	                                ...
	                                onChange: function onChange(e) {
	                                    _this.setState({ new_entr_floors: e.target.value });
	                                }
	                            })
	                        ),
	                        React.createElement(
	                            ...
	                            React.createElement('input', { type: 'checkbox',
	                                ...
	                                onChange: function onChange(e) {
	                                    _this.setState({ new_entr_interior: e.target.checked ? 1 : 0 });
	                                },
	                        ...
	                        React.createElement(
	                            'td',
	                            null,
	                            this.state.new_entr_id && this.state.new_entr_floors ? React.createElement(
	                                'button',
	                                { className: 'btn btn-primary btn-xs', onClick: this.addEntrance },
	                                '\u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C'
	                            ) : ''
	                        )
	                    ),
	...
	ReactDOM.render(React.createElement(Entrances, { address_id: BuildingData.address_id, object_type: 'build' }), document.getElementById('table-entrances'));
