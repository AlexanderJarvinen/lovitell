...
/***/ function(module, exports, __webpack_require__) {
	...
	var columns = [{
	    ...
	    cell: {
	        formatters: [function (priority) {
	            return priority ? React.createElement(
	                'span',
	                null,
	                '!'
	            ) : '';
	...
	var TroubleParamsPane = React.createClass({
	    ...
	    handleDateRangeSelect: function handleDateRangeSelect(date_range) {
	        this.setState({
	    ...
	    render: function render() {
	        return React.createElement(
	            'div',
	            { className: 'report_params_pane' },
	            React.createElement(DateRangeSelect, {
	...
	var TroubleList = React.createClass({
	    ...
	    componentDidMount: function componentDidMount() {
	        var _props = this.props,
	            type = _props.type,
	            address_id = _props.address_id,
	            start_date = _props.start_date,
	            end_date = _props.end_date;

	        this.loadTroubles(type, address_id, start_date, end_date);
	    },
	    componentWillReceiveProps: function componentWillReceiveProps(np) {
	        if (np.type != this.props.type || np.address_id != this.props.address_id || np.start_date != this.props.start_date || np.end_date != this.props.end_date) {
	            this.loadTroubles(np.type, np.address_id, np.start_date, np.end_date);
	        }
	    },

	    makeTroubleList: function makeTroubleList(a) {
	        if (a.error == 0) {
	            this.setState({
	                troubles: a.data,
	                rights: true
	    ...
	    loadTroubles: function loadTroubles(type, address_id, start_date, end_date) {
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    this.state.troubles.length ? React.createElement(Table.Body, {
	...
	var Troubles = React.createClass({
	    ...
	    handleSearch: function handleSearch(date_range) {
	    ...
	    render: function render() {
	        return React.createElement(
	            'div',
	            { className: 'col-md-8' },
	            React.createElement(TroubleParamsPane, {
	                date_range: this.state.date_range,
	                onSearch: this.handleSearch
	            }),
	            React.createElement(TroubleList, {
	                type: 1,
	...
	ReactDOM.render(React.createElement(Troubles, { address_id: BuildingData.address_id }), document.getElementById('troubles-list'));
