...
/***/ function(module, exports, __webpack_require__) {
	...
	var SidebarActions = __webpack_require__(1039);
	var SidebarStore = __webpack_require__(1041);
	...
	var UserPanel = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement('div', { className: 'user-panel' });
	    }
	});
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement('input', { type: 'text', name: 'q', className: 'form-control', placeholder: '\u041F\u043E\u0438\u0441\u043A...', onChange: this.handleChange, value: this.state.search }),
	                React.createElement(
	                    'span',
	                    { className: 'input-group-btn' },
	                    React.createElement(
	                        'button',
	                        { type: 'submit', name: 'search', id: 'search-btn', className: 'btn btn-flat', onClick: this.handleClick },
	        ...
	        if (Array.isArray(item.submenu)) {
	            ...
	            for (var submenu_item in item.submenu) {
	                ...
	                submenu.push(React.createElement(
	                    'li',
	                    { key: item + "-" + submenu_item, className: classNames({ active: row.href == href }) },
	                    React.createElement(
	                        'a',
	                        { href: row.href, title: row.note || '' },
	            ...
	            if (submenu != null) {
	                return React.createElement(
	                    'li',
	                    { key: item, className: classNames({ active: submenu_active }) },
	                    React.createElement(
	                        'a',
	                        { href: '#', onClick: this.activate.bind(this, item.name) },
	    ...
	    render: function render() {
	        ...
	        for (var group in allmenu) {
	            ...
	            for (var item in items) {
	                group_menus.push(React.createElement(MenuItem, { key: item, item: items[item] }));
	            }
	            groups.push(React.createElement(
	                'li',
	                { className: 'header', key: group },
	                group
	            ));
	            if (group_menus) {
	...
	var Sidebar = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            'section',
	            { className: 'sidebar' },
	            React.createElement(UserPanel, { user: this.props.user }),
	            React.createElement(SearchForm, { search_string: this.state.menu.search_string }),
	            React.createElement(Menu, { menu: this.state.menu.menu })
	        );
	    },
	...
	ReactDOM.render(React.createElement(Sidebar, { user: User }), document.getElementById('main-sidebar'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SidebarConstants = __webpack_require__(1040);

	var SidebarActions = {
	    /**
	     * @param  {string} search_text
	     */
	    search: function search(search_text) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SidebarDispatcher = __webpack_require__(457);
	...
	var SidebarStore = assign({}, EventEmitter.prototype, {
	    ...
	    search: function search(search_string) {
