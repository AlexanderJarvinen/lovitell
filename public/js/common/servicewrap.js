...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactDatepicker = __webpack_require__(812);
	...
	var _BoxOverlay = __webpack_require__(1038);

	var _BoxOverlay2 = _interopRequireDefault(_BoxOverlay);

	var _reactDom = __webpack_require__(162);

	var _reactDom2 = _interopRequireDefault(_reactDom);

	var _reactAutocomplete = __webpack_require__(748);
	...
	var ServiceTableRow = function (_Component) {
	  _inherits(ServiceTableRow, _Component);
	  ...
	  function ServiceTableRow() {
	    ...
	    _classCallCheck(this, ServiceTableRow);

	    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	      args[_key] = arguments[_key];
	    }

	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ServiceTableRow.__proto__ || Object.getPrototypeOf(ServiceTableRow)).call.apply(_ref, [this].concat(args))), _this), _this.defaultProps = {
	      id: '',
	      name: '',
	      plan_date: {
	        value: '',
	      ...
	      lockPermitDate: null
	    }, _this.acceptanceTooltip = null, _this.acceptancePlanTooltip = null, _this.planTooltip = null, _this.acceptedTooltip = null, _this.toDisableTooltip = null, _this.disableTooltip = null, _this.permitTooltip = null, _this.permitFromDateTooltip = null, _this.permitToDateTooltip = null, _this.state = {
	      newPermit: false,
	      permitsList: [],
	      permitState: 0,
	      state: []
	      ...
	      if (np.acceptance_date.msg != '') {
	        _reactTooltip2.default.show(_this.acceptanceTooltip);
	      } else {
	        _reactTooltip2.default.hide(_this.acceptanceTooltip);
	      }
	      if (np.acceptance_plan_date.msg != '') {
	        _reactTooltip2.default.show(_this.acceptancePlanTooltip);
	      } else {
	        _reactTooltip2.default.hide(_this.acceptancePlanTooltip);
	      }
	      if (np.plan_date.msg != '') {
	        _reactTooltip2.default.show(_this.planTooltip);
	      } else {
	        _reactTooltip2.default.hide(_this.planTooltip);
	      }
	      if (np.accepted_date.msg != '') {
	        _reactTooltip2.default.show(_this.acceptedTooltip);
	      } else {
	        _reactTooltip2.default.hide(_this.acceptedTooltip);
	      }
	      if (np.to_disable_date.msg != '') {
	        _reactTooltip2.default.show(_this.toDisableTooltip);
	      } else {
	        _reactTooltip2.default.hide(_this.toDisableTooltip);
	      }
	      if (np.disable_date.msg != '') {
	        _reactTooltip2.default.show(_this.disableTooltip);
	      } else {
	        _reactTooltip2.default.hide(_this.disableTooltip);
	      }
	      if (np.permit.msg != '') {
	        _reactTooltip2.default.show(_this.permitTooltip);
	      } else {
	        _reactTooltip2.default.hide(_this.permitTooltip);
	      }
	      if (np.permit_from_date.msg != '') {
	        _reactTooltip2.default.show(_this.permitFromDateTooltip);
	      } else {
	        _reactTooltip2.default.hide(_this.permitFromDateTooltip);
	      }
	      if (np.permit_to_date.msg != '') {
	        _reactTooltip2.default.show(_this.permitToDateTooltip);
	      } else {
	        _reactTooltip2.default.hide(_this.permitToDateTooltip);
	      }
	    }, _this.handlePlanDateChange = function (date) {
	      if (typeof _this.props.onChange != 'undefined') {
	        _this.props.onChange({
	          ...
	          date_1: _this.props.acceptance_date,
	          date_2: _this.props.acceptance_plan_date,
	          date_4: _this.props.accepted_date,
	          date_8: _this.props.to_disable_date,
	          date_16: _this.props.disable_date,
	          permit: _this.props.permit,
	          permit_to_date: _this.props.permit_to_date,
	          permit_from_date: _this.props.permit_from_date,
	          changed: true
	        });
	      }
	    }, _this.handleAccDateChange = function (date) {
	      if (typeof _this.props.onChange != 'undefined') {
	        _this.props.onChange({
	          id: _this.props.id,
	          name: _this.props.name,
	          date_0: _this.props.plan_date,
	          date_1: {
	            value: date ? date.format('YYYY-MM-DD') : '',
	            state: 1,
	            msg: ''
	    ...
	    }, _this.handleAccPlanDateChange = function (date) {
	      if (typeof _this.props.onChange != 'undefined') {
	        _this.props.onChange({
	          id: _this.props.id,
	          name: _this.props.name,
	    ...
	    }, _this.handleAcceptedDateChange = function (date) {
	      if (typeof _this.props.onChange != 'undefined') {
	        _this.props.onChange({
	          id: _this.props.id,
	          name: _this.props.name,
	    ...
	    }, _this.handleToDisableDateChange = function (date) {
	      if (typeof _this.props.onChange != 'undefined') {
	        _this.props.onChange({
	          id: _this.props.id,
	          name: _this.props.name,
	    ...
	    }, _this.handleDisableDateChange = function (date) {
	      if (typeof _this.props.onChange != 'undefined') {
	        _this.props.onChange({
	          id: _this.props.id,
	          name: _this.props.name,
	    ...
	    }, _this.handlePermitChange = function (e, v) {
	      _this.setState({ lockPermitDate: false });
	      if (typeof _this.props.onChange != 'undefined') {
	        _this.props.onChange({
	          id: _this.props.id,
	          name: _this.props.name,
	      ...
	      _this.loadPermits(v);
	    }, _this.handlePermitSelect = function (v, i) {
	      ...
	      if (typeof _this.props.onChange != 'undefined') {
	        _this.props.onChange({
	          ...
	          permit_from_date: {
	            value: (0, _moment2.default)(i.date_from).format('YYYY-MM-DD'),
	            state: 1,
	            msg: ''
	          },
	          permit_to_date: {
	            value: (0, _moment2.default)(i.date_to).format('YYYY-MM-DD'),
	            state: 1,
	            msg: ''
	          },
	          changed: true
	      ...
	      _this.setState({ lockPermitDate: true });
	    }, _this.handlePermitFromDateChange = function (date) {
	      if (typeof _this.props.onChange != 'undefined') {
	        _this.props.onChange({
	          id: _this.props.id,
	          name: _this.props.name,
	          ...
	          date_4: _this.props.accepted_date,
	          date_8: _this.props.to_disable_date,
	          date_16: _this.props.to_disable_date,
	          permit: _this.props.permit,
	          permit_from_date: {
	            value: date ? date.format('YYYY-MM-DD') : '',
	            state: 1,
	    ...
	    }, _this.handlePermitToDateChange = function (date) {
	      if (typeof _this.props.onChange != 'undefined') {
	        _this.props.onChange({
	          id: _this.props.id,
	          name: _this.props.name,
	      ...
	      _this.state.services = services;
	    }, _this.loadPermits = function (searchString) {
	      fetch('/inventory/ajax/permits/' + searchString, { method: 'GET', credentials: 'include' }).then(function (resp) {
	        return resp.json();
	      }).then(function (data) {
	        if (!data.error) {
	          var list = [];
	    ...
	    }, _this.handlePermitSave = function () {
	      ...
	      var data = JSON.stringify({
	        number: _this.props.permit_from_date.value,
	        permit_from_date: _this.props.permit_to_date.value,
	        permit_to_date: _this.props.permit_to_date.value
	      });
	      fetch('/inventory/ajax/permit', {
	        headers: {
	        ...
	        if (resp.error == 0) {
	          var _permit = _this.props.permit;
	          _permit.id = resp.id;
	          _this.setState({
	            permitState: 2,
	            permit: _permit
	  ...
	  _createClass(ServiceTableRow, [{
	    key: 'render',
	    value: function render() {
	      var field_plan = _react2.default.createElement(
	        'span',
	        { className: 'form-control' },
	        this.props.plan_date.value
	      );
	      var field_acceptance = _react2.default.createElement(
	        'span',
	        { className: 'form-control' },
	        this.props.acceptance_date.value
	      );
	      var field_plan_acceptance = _react2.default.createElement(
	        'span',
	        { className: 'form-control' },
	        this.props.acceptance_plan_date.value
	      );
	      var field_accepted = _react2.default.createElement(
	        'span',
	        { className: 'form-control' },
	        this.props.accepted_date.value
	      );
	      var field_to_disable = _react2.default.createElement(
	        'span',
	        { className: 'form-control' },
	        this.props.to_disable_date.value
	      );
	      var field_disable = _react2.default.createElement(
	        'span',
	        { className: 'form-control' },
	        this.props.disable_date.value
	      );
	      var field_permit = _react2.default.createElement(
	        'span',
	        { className: 'form-control' },
	        this.props.permit.value
	      );
	      var field_permit_from_date = _react2.default.createElement(
	        'span',
	        { className: 'form-control' },
	        this.props.permit_from_date.value
	      );
	      var field_permit_to_date = _react2.default.createElement(
	        'span',
	        { className: 'form-control' },
	        this.props.permit_to_date.value
	      );
	      if (this.props.rights != 0) {
	        field_acceptance = _react2.default.createElement(
	          'span',
	          { className: (0, _classnames2.default)('inputrow', {
	          ...
	          _react2.default.createElement(_reactDatepicker2.default, {
	            ...
	            selected: this.props.acceptance_date.value != '' ? (0, _moment2.default)(this.props.acceptance_date.value, 'YYYY-MM-DD') : '',
	            onChange: this.handleAccDateChange,
	            isClearable: true,
	            placeholderText: '',
	            className: 'form-control'
	          }),
	          this.props.acceptance_date.msg != '' ? _react2.default.createElement(
	            'span',
	            { className: 'help-block' },
	            this.props.acceptance_date.msg
	          ) : ''
	        );
	        field_plan_acceptance = _react2.default.createElement(
	          'span',
	          { className: (0, _classnames2.default)('inputrow', {
	          ...
	          _react2.default.createElement(_reactDatepicker2.default, {
	            dateFormat: 'YYYY-MM-DD',
	            selected: this.props.acceptance_plan_date.value != '' ? (0, _moment2.default)(this.props.acceptance_plan_date.value, 'YYYY-MM-DD') : '',
	            onChange: this.handleAccPlanDateChange,
	            isClearable: true,
	            placeholderText: '',
	            className: 'form-control'
	          }),
	          this.props.acceptance_plan_date.msg != '' ? _react2.default.createElement(
	            'span',
	            { className: 'help-block' },
	            this.props.acceptance_plan_date.msg
	          ) : ''
	        );
	        field_plan = _react2.default.createElement(
	          'span',
	          { className: (0, _classnames2.default)('inputrow', {
	          ...
	          _react2.default.createElement(_reactDatepicker2.default, {
	            dateFormat: 'YYYY-MM-DD',
	            selected: this.props.plan_date.value != '' ? (0, _moment2.default)(this.props.plan_date.value, 'YYYY-MM-DD') : '',
	            onChange: this.handlePlanDateChange,
	            isClearable: true,
	            placeholderText: '',
	            className: 'form-control'
	          }),
	          this.props.plan_date.msg != '' ? _react2.default.createElement(
	            'span',
	            { className: 'help-block' },
	            this.props.plan_date.msg
	          ) : ''
	        );
	        field_accepted = _react2.default.createElement(
	          'span',
	          { className: (0, _classnames2.default)('inputrow', {
	          ...
	          _react2.default.createElement(_reactDatepicker2.default, {
	            dateFormat: 'YYYY-MM-DD',
	            selected: this.props.accepted_date.value != '' ? (0, _moment2.default)(this.props.accepted_date.value, 'YYYY-MM-DD') : '',
	            onChange: this.handleAcceptedDateChange,
	            isClearable: true,
	            placeholderText: '',
	            className: 'form-control'
	          }),
	          this.props.accepted_date.msg != '' ? _react2.default.createElement(
	            'span',
	            { className: 'help-block' },
	            this.props.accepted_date.msg
	          ) : ''
	        );
	        field_to_disable = _react2.default.createElement(
	          'span',
	          { className: (0, _classnames2.default)('inputrow', {
	          ...
	          _react2.default.createElement(_reactDatepicker2.default, {
	            dateFormat: 'YYYY-MM-DD',
	            selected: this.props.to_disable_date.value != '' ? (0, _moment2.default)(this.props.to_disable_date.value, 'YYYY-MM-DD') : '',
	            onChange: this.handleToDisableDateChange,
	            isClearable: true,
	            placeholderText: '',
	            className: 'form-control'
	          }),
	          this.props.to_disable_date.msg != '' ? _react2.default.createElement(
	            'span',
	            { className: 'help-block' },
	            this.props.to_disable_date.msg
	          ) : ''
	        );
	        field_disable = _react2.default.createElement(
	          'span',
	          { className: (0, _classnames2.default)('inputrow', {
	          ...
	          _react2.default.createElement(_reactDatepicker2.default, {
	            dateFormat: 'YYYY-MM-DD',
	            selected: this.props.disable_date.value != '' ? (0, _moment2.default)(this.props.disable_date.value, 'YYYY-MM-DD') : '',
	            onChange: this.handleDisableDateChange,
	            isClearable: true,
	            placeholderText: '',
	            className: 'form-control'
	          }),
	          this.props.disable_date.msg != '' ? _react2.default.createElement(
	            'span',
	            { className: 'help-block' },
	            this.props.disable_date.msg
	          ) : ''
	        );
	        field_permit = _react2.default.createElement(
	          'span',
	          { className: (0, _classnames2.default)('inputrow', {
	          ...
	          this.props.disable_date.msg != '' ? _react2.default.createElement(
	            'span',
	            { className: 'help-block' },
	            this.props.permit.msg
	          ) : ''
	        );
	        field_permit_from_date = _react2.default.createElement(
	          'span',
	          { className: (0, _classnames2.default)('inputrow', {
	          ...
	          _react2.default.createElement(_reactDatepicker2.default, {
	            dateFormat: 'YYYY-MM-DD',
	            selected: this.props.permit_from_date.value != '' ? (0, _moment2.default)(this.props.permit_from_date.value, 'YYYY-MM-DD') : '',
	          ...
	          this.props.disable_date.msg != '' ? _react2.default.createElement(
	            'span',
	            { className: 'help-block' },
	            this.props.permit_from_date.msg
	          ) : ''
	        );
	        field_permit_to_date = _react2.default.createElement(
	          'span',
	          { className: (0, _classnames2.default)('inputrow', {
	          ...
	          _react2.default.createElement(_reactDatepicker2.default, {
	            dateFormat: 'YYYY-MM-DD',
	            selected: this.props.permit_to_date.value != '' ? (0, _moment2.default)(this.props.permit_to_date.value, 'YYYY-MM-DD') : '',
	          ...
	          this.props.disable_date.msg != '' ? _react2.default.createElement(
	            'span',
	            { className: 'help-block' },
	            this.props.permit_to_date.msg
	          ) : ''
	        );
	      }
	      var permitSaveMsg = null;
	      if (this.props.permit.state == 1 && !this.props.permit.id && this.props.permit_from_date.state == 1 && this.props.permit_to_date.state == 1) {
	        permitSaveMsg = _react2.default.createElement(
	          'span',
	          { className: 'help-block ' },
	          '\u0414\u0430\u043D\u043D\u044B\u0439 \u043D\u043E\u043C\u0435\u0440 \u0440\u0430\u0437\u0440\u0435\u0448\u0435\u043D\u0438\u044F \u043D\u0435 \u043D\u0430\u0439\u0434\u0435\u043D. ',
	          _react2.default.createElement(
	            'button',
	            {
	              className: 'btn btn-xs btn-primary', onClick: this.handlePermitSave },
	            '\u0421\u043E\u0445\u0440\u0430\u043D\u0438\u0442\u044C'
	          )
	        );
	      } else {
	        switch (this.state.permitState) {
	          case 2:
	            permitSaveMsg = _react2.default.createElement(
	              'span',
	              { className: 'help-block ok-message' },
	              '\u0420\u0430\u0437\u0440\u0435\u0448\u0435\u0438\u0435 \u0443\u0441\u043F\u0435\u0448\u043D\u043E \u0441\u043E\u0445\u0440\u0430\u043D\u0435\u043D'
	            );
	            break;
	          case -1:
	            permitSaveMsg = _react2.default.createElement(
	...
	exports.default = ServiceTableRow;
	;

	var ServiceWrap = function (_Component2) {
	  _inherits(ServiceWrap, _Component2);

	  function ServiceWrap(props) {
	    _classCallCheck(this, ServiceWrap);

	    var _this2 = _possibleConstructorReturn(this, (ServiceWrap.__proto__ || Object.getPrototypeOf(ServiceWrap)).call(this, props));
	    ...
	    _this2.componentDidMount = function () {
	      if (!_this2.props.services) {
	        console.log('Get services');
	        _this2.getServices();
	      } else {
	        _this2.initServices(services);
	      }
	    };

	    _this2.initServices = function (services) {
	      for (var i in services) {
	    ...
	    _this2.getServices = function () {
	      _this2.setState({ loading: true });
	      fetch('/inventory/ajax/building/' + _this2.props.addressId + '/services', {
	        method: 'GET',
	        credentials: 'include'
	      }).then(function (resp) {
	        return resp.json();
	        ...
	        console.log(resp);
	        _this2.initServices(resp);
	        _this2.setState({ loading: false });
	      });
	    };

	    _this2.handleServiceChange = function (service) {
	      var service_list = _this2.state.services;
	    ...
	    _this2.handleSave = function () {
	      _this2.setState({ loading: true });
	      var data = JSON.stringify({
	        services: _this2.state.services
	      });
	      ...
	      fetch('/inventory/ajax/building/' + _this2.props.addressId + '/services', {
	        ...
	        if (resp.error != 0) {
	          var _services = _this2.state.services;
	          var save_state = resp.state;
	          for (var i in _services) {
	            if (save_state[_services[i].id]) {
	              for (var d in save_state[_services[i].id]) {
	                _services[i][d].state = save_state[_services[i].id][d].error == 0 ? 2 : -1;
	                if (save_state[_services[i].id][d].error != 0) {
	                  _services[i][d].msg = save_state[_services[i].id][d].msg;
	                }
	              }
	            }
	          }
	          ...
	          var _services2 = _this2.state.services;
	          var _save_state = resp.state;
	          for (var _i in _services2) {
	            if (_save_state[_services2[_i].id]) {
	              for (var _d in _save_state[_services2[_i].id]) {
	                _services2[_i][_d].state = 0;
	              }
	            }
	          }
	          _this2.setState({
	  ...
	  _createClass(ServiceWrap, [{
	    key: 'render',
	    value: function render() {
	      var rows = [];
	      for (var i in this.state.services) {
	        var s = this.state.services[i];
	        rows.push(_react2.default.createElement(ServiceTableRow, {
	          key: 'service' + i,
	          id: s.id,
	          name: s.name,
	      ...
	      var style = (0, _classnames2.default)('table', 'table-bordered', 'table-hover', 'dataTable', 'service-table', {
	      ...
	      return _react2.default.createElement(
	        'div',
	        { className: 'service_wrap col-md-12' },
	        _react2.default.createElement(
	          'div',
	          ...
	          _react2.default.createElement(
	            ...
	            this.state.state == 1 ? _react2.default.createElement(
	              'button',
	              { className: 'btn btn-primary', onClick: this.handleSave },
	              '\u0421\u043E\u0445\u0440\u0430\u043D\u0438\u0442\u044C'
	            ) : null
	          ),
	          _react2.default.createElement(_BoxOverlay2.default, {
	...
	ServiceWrap.propTypes = {
	  services: _react.PropTypes.array,
	  addressId: _react.PropTypes.number.isRequired
	};

	;

	_reactDom2.default.render(_react2.default.createElement(ServiceWrap, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	;(function (global, factory) {
	    true ? factory(__webpack_require__(467)) :
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (root, factory) {
	  if (true) {
	    ...
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(162)], __WEBPACK_AMD_DEFINE_RESULT__ = function(reactDom) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BoxOverlay = function (_Component) {
	    _inherits(BoxOverlay, _Component);
	    ...
	    function BoxOverlay() {
	        ...
	        _classCallCheck(this, BoxOverlay);

	        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	            args[_key] = arguments[_key];
	        }

	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = BoxOverlay.__proto__ || Object.getPrototypeOf(BoxOverlay)).call.apply(_ref, [this].concat(args))), _this), _this.defaultProps = {
	            show: false
	        }, _temp), _possibleConstructorReturn(_this, _ret);
	    }

	    _createClass(BoxOverlay, [{
	        key: "render",
	        value: function render() {
	            if (this.props.show) {
	                return _react2.default.createElement(
	                    "div",
	                    { "class": "overlay" },
	                    _react2.default.createElement("i", { "class": "fa fa-refresh fa-spin" })
	                );
	            } else {
	                return null;
	            }
