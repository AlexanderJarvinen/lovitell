...
/***/ function(module, exports, __webpack_require__) {
	...
	var ConfirmMessageBox = function (_Component) {
	  _inherits(ConfirmMessageBox, _Component);
	  ...
	  function ConfirmMessageBox() {
	    ...
	    _classCallCheck(this, ConfirmMessageBox);

	    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	      args[_key] = arguments[_key];
	    }

	    return _ret = (_temp = (_this2 = _possibleConstructorReturn(this, (_ref = ConfirmMessageBox.__proto__ || Object.getPrototypeOf(ConfirmMessageBox)).call.apply(_ref, [this].concat(args))), _this2), _this2.render = function () {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            null,
	            'Конфигурирование точки доступа ' + route
	          )
	        ),
	        _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'button',
	            { type: 'button', className: 'btn btn-default', onClick: _this2.props.onHide },
	            '\u0417\u0430\u043A\u0440\u044B\u0442\u044C'
	          )
	        )
	      );
	...
	var ConfigureAP = function (_Component2) {
	  _inherits(ConfigureAP, _Component2);
	  ...
	  function ConfigureAP() {
	    ...
	    _classCallCheck(this, ConfigureAP);

	    for (var _len2 = arguments.length, args = Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
	      args[_key2] = arguments[_key2];
	    }

	    return _ret2 = (_temp2 = (_this3 = _possibleConstructorReturn(this, (_ref2 = ConfigureAP.__proto__ || Object.getPrototypeOf(ConfigureAP)).call.apply(_ref2, [this].concat(args))), _this3), _this3.state = {
	      error: 0,
	      show: false
	    }, _this3.routeConfig = function () {
	      var that = _this3;
	      if (_this3.props.route) {
	        $.ajax({
	          url: "/inventory/ajax/configure-route/" + _this3.props.route,
	          type: "GET",
	          dataType: "json",
	      ...
	      return _react2.default.createElement(
	        'div',
	        { className: 'route-configure' },
	        _react2.default.createElement(
	          'a',
	          { onClick: _this3.routeConfig },
	          '\u041D\u0430\u0441\u0442\u0440\u043E\u0438\u0442\u044C'
	        ),
	        _react2.default.createElement(ConfirmMessageBox, {
	          show: _this3.state.show,
	          error: _this3.state.error,
	          msg: _this3.state.msg,
	...
	ConfigureAP.propTypes = {
	  route: _react.PropTypes.string.isRequired
	};


	_reactDom2.default.render(_react2.default.createElement(ConfigureAP, {
	  route: route
