...
/***/ function(module, exports, __webpack_require__) {
	...
	var DateRangeSelect = __webpack_require__(811);
	...
	var Clients = React.createClass({
	    ...
	    makeClientList: function makeClientList(a) {
	        if (a.error == 0) {
	            this.setState({
	                clients: a.data
	            });
	    ...
	    loadClients: function loadClients(address_id) {
	        $.ajax({
	            type: 'GET',
	    ...
	    render: function render() {
	        var tbody = this.state.clients.length ? React.createElement(Table.Body, {
	...
	ReactDOM.render(React.createElement(Clients, { address_id: BuildingData.address_id }), document.getElementById('clients-list'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DateRangeSelect = React.createClass({
	    ...
	    changeStartDate: function changeStartDate(date) {
	        ...
	        var end = this.props.end_date ? moment(this.props.end_date) : moment();
	        if (start.diff(end) > 0) {
	            end = start;
	        }
	    ...
	    changeEndDate: function changeEndDate(date) {
	        var start = this.props.start_date ? moment(this.props.start_date) : moment(date);
	        var end = moment(date);
	        if (start.diff(end) > 0) {
	            start = end;
	        }
	    ...
	    render: function render() {
	        return React.createElement(
	            'div',
	            { className: classNames('b-date-range', { 'j-inline': this.props.inline }) },
	            React.createElement(
	                'div',
	                { className: 'inputrow' },
	                React.createElement(
