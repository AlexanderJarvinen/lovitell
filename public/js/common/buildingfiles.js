...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LoadBar = __webpack_require__(463);

	var _LoadBar2 = _interopRequireDefault(_LoadBar);

	var _AppActions = __webpack_require__(456);

	var _AppActions2 = _interopRequireDefault(_AppActions);

	var _ErrorMsg = __webpack_require__(604);

	var _ErrorMsg2 = _interopRequireDefault(_ErrorMsg);

	var _reactBootstrap = __webpack_require__(46);

	var _DraggableModalDialog = __webpack_require__(578);

	var _DraggableModalDialog2 = _interopRequireDefault(_DraggableModalDialog);
	...
	var BuildingFiles = function (_Component) {
	    _inherits(BuildingFiles, _Component);

	    function BuildingFiles(props) {
	        _classCallCheck(this, BuildingFiles);

	        var _this = _possibleConstructorReturn(this, (BuildingFiles.__proto__ || Object.getPrototypeOf(BuildingFiles)).call(this, props));

	        _this.deleteFile = function (href) {
	            console.log(href);
	            fetch(href, {
	                headers: {
	        ...
	        _this.getColumns = function () {
	            return [{
	                ...
	                cell: {
	                    formatters: [function (file_name, row) {
	                        return _react2.default.createElement(
	                            'a',
	                            { href: row.rowData.href, target: '_blank' },
	                            file_name
	                        );
	                    }]
	                }
	                ...
	                cell: {
	                    formatters: [function (id, row) {
	                        if (row.rowData.can_delete) return _react2.default.createElement('i', { className: 'fa fa-times link', onClick: function onClick(id) {
	                                _this.deleteFile(row.rowData.href);
	                            } });else return '';
	                    }]
	                }
	            }];
	        ...
	        _this.getFiles = function () {
	            _AppActions2.default.initLoading();
	            fetch('/inventory/ajax/building/' + _this.props.addressId + '/files/', { method: 'GET', credentials: 'include' }).then(function (response) {
	                return response.json();
	            }).then(function (json) {
	                _AppActions2.default.cancelLoading();
	                if (json.error == 0) {
	                    _this.setState({ files: json.data });
	                }
	            });
	        };
	        ...
	        _this.handleAddFile = function () {
	            _this.getFiles();
	        };

	        _this.onRow = function (row, _ref) {
	            var rowIndex = _ref.rowIndex;

	            var rowClass = (0, _classnames2.default)({ 'odd-row': rowIndex % 2 == 0 }, { 'even-row': rowIndex % 2 != 0 });
	            return {
	                className: rowClass
	            };
	        };
	        ...
	        _this.render = function () {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _this.state.files.length > 0 ? _react2.default.createElement(Table.Body, {
	                        rows: _this.state.files,
	                        rowKey: 'id',
	                        onRow: _this.onRow
	                    }) : _react2.default.createElement(
	                        'tbody',
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                'td',
	                                { colSpan: _this.getColumns().length },
	                                '\u0424\u0430\u0439\u043B\u043E\u0432 \u043D\u0435 \u043D\u0430\u0439\u0434\u0435\u043D\u043E'
	                            )
	                        )
	                    )
	                ),
	                _react2.default.createElement(UploadFileFormModal, {
	                    onAddFile: _this.handleAddFile,
	                    addressId: _this.props.addressId,
	                    can_addfiles: _this.props.can_addfiles == 1
	                })
	            );
	        };
	...
	BuildingFiles.propTypes = {
	    addressId: _react.PropTypes.number.isRequired
	};
	exports.default = BuildingFiles;
	;

	var UploadFileFormModal = function (_Component2) {
	    _inherits(UploadFileFormModal, _Component2);

	    function UploadFileFormModal(props) {
	        _classCallCheck(this, UploadFileFormModal);

	        var _this2 = _possibleConstructorReturn(this, (UploadFileFormModal.__proto__ || Object.getPrototypeOf(UploadFileFormModal)).call(this, props));

	        _this2.componentDidMount = function () {
	            _this2.getGroups();
	        };

	        _this2.handleFileUpload = function (e) {
	            e.preventDefault();
	            var fd = new FormData();
	            fd.append('file', _this2.state.file);
	            fd.append('note', _this2.state.note.value);
	            fd.append('group_id', _this2.state.groupId);
	            fd.append('subgroup_id', _this2.state.subgroupId);
	            fetch('/inventory/ajax/building/' + _this2.props.addressId + '/file', {
	                headers: {
	                    'X-CSRF-Token': document.querySelector("meta[name='csrf-token']") ? document.querySelector("meta[name='csrf-token']").getAttribute('content') : ''
	                },
	                method: 'POST',
	                ...
	                _this2.handleClose();_this2.props.onAddFile();
	            });
	        };

	        _this2.handleFileChange = function (e) {
	            _this2.setState({ file: e.target.files[0] });
	        };

	        _this2.handleNoteChange = function (note) {
	            _this2.setState({
	                note: note
	            });
	        };

	        _this2.getGroups = function () {
	            fetch('/inventory/ajax/building/file/groups/', { method: 'GET', credentials: 'include' }).then(function (response) {
	                return response.json();
	            }).then(function (json) {
	                if (json.error == 0) {
	                    _this2.setState({
	                    ...
	                    }, _this2.getSubgroups(json.data[0].id));
	                }
	            });
	        };

	        _this2.getSubgroups = function (group_id) {
	            if (group_id != 0) {
	                fetch('/inventory/ajax/building/file/group/' + group_id + '/subgroups', { method: 'GET', credentials: 'include' }).then(function (response) {
	                    return response.json();
	                }).then(function (json) {
	                    if (json.error == 0) {
	                        _this2.setState({
	                ...
	                _this2.setState({ fileSubgroups: [], subgroupId: 0 });
	            }
	        };
	        ...
	        _this2.handleClose = function () {
	            _this2.setState({
	                ...
	                groupdId: _this2.state.fileGroups[0].id
	            });
	            _this2.getSubgroups(_this2.state.fileGroups[0].id);
	        };

	        _this2.checkFields = function () {
	            return true;
	        };

	        _this2.render = function () {
	            if (!_this2.props.can_addfiles) return null;
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    {
	                        dialogComponentClass: _DraggableModalDialog2.default,
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(_FormTextField2.default, {
	                            label: '\u041E\u043F\u0438\u0441\u0430\u043D\u0438\u0435',
	                            value: _this2.state.note.value,
	                            state: _this2.state.note.state,
	                            msg: _this2.state.note.msg,
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                { onChange: function onChange(e) {
	                                        _this2.setState({ groupId: e.target.value }, _this2.getSubgroups(e.target.value));
	                                    } },
	                                _this2.state.fileGroups.map(function (item) {
	                                    return _react2.default.createElement(
	                                        'option',
	                                        { value: item.id },
	                                        item.name
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                {
	                                    onChange: function onChange(e) {
	                                        _this2.setState({ subgroupId: e.target.value });
	                                    }
	                                },
	                                _this2.state.fileSubgroups.map(function (item) {
	                                    return _react2.default.createElement(
	                                        'option',
	                                        { value: item.id },
	                                        item.name
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        null,
	                        _this2.checkFields() ? _react2.default.createElement(
	                            'button',
	                            { type: 'button', className: 'btn btn-default', onClick: _this2.handleFileUpload },
	                            '\u0417\u0430\u0433\u0440\u0443\u0437\u0438\u0442\u044C'
	                        ) : null,
	                        _react2.default.createElement(
	                            'button',
	                            { type: 'button', className: 'btn btn-default', onClick: _this2.handleClose },
	                            '\u0417\u0430\u043A\u0440\u044B\u0442\u044C'
	                        )
	                    )
	                ),
	                _react2.default.createElement(_LoadBar2.default, null),
	                _react2.default.createElement(_ErrorMsg2.default, null)
	            );
	        };
	    ...
	    return UploadFileFormModal;
	}(_react.Component);

	UploadFileFormModal.propTypes = {
	    addressId: _react.PropTypes.number.isRequired,
	    onAddFile: _react.PropTypes.func,
	    can_addfiles: _react.PropTypes.bool
	};
	;

	_reactDom2.default.render(_react2.default.createElement(BuildingFiles, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = DraggableModalDialog;
