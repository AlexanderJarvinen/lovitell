...
/***/ function(module, exports, __webpack_require__) {
	...
	var CitySelect = __webpack_require__(745);
	var RegionSelect = __webpack_require__(746);
	var StreetSelect = __webpack_require__(747);
	var BuildSelect = __webpack_require__(753);
	var AddressSelector = __webpack_require__(754);
	var Pagination = __webpack_require__(756);
	...
	var columns = [{
	    ...
	    cell: {
	        formatters: [function (region, row) {
	            return React.createElement(
	                'span',
	                null,
	                region,
	                '-',
	                row.rowData.address_id
	            );
	        }]
	    }
	}, {
	        ...
	        formatters: [function (house, row) {
	            ...
	            if (row.rowData.view_permissions) {
	                link = React.createElement(
	                    'a',
	                    { target: '_blank', href: '/inventory/building/' + row.rowData.address_id },
	                    house
	                );
	            }
	            return link;
	...
	var CustomFooter = function CustomFooter(_ref) {
	    var columns = _ref.columns,
	        page = _ref.page,
	        rows_count = _ref.rows_count,
	        on_page = _ref.on_page,
	    ...
	    return React.createElement(
	        ...
	        React.createElement(
	            ...
	            React.createElement(
	                'td',
	                { key: 'footer', colSpan: columns.length },
	...
	var BuildList = React.createClass({
	    ...
	    handleAddrIdChange: function handleAddrIdChange(e) {
	        var address_id = e.target.value.replace(/[^0-9]/g, '');
	        this.setState({
	            address_id: address_id
	        });
	    },
	    handleCityChange: function handleCityChange(city) {
	        this.setState({
	            city_id: city.city_id,
	            city: city.city
	        }, this.checkParams);
	    },
	    handleRegionChange: function handleRegionChange(region) {
	        this.setState({
	            region: region.region,
	            region_id: region.region_id
	        }, this.checkParams);
	    },
	    handleStreetChange: function handleStreetChange(street) {
	        this.setState({
	    ...
	    handleBuildChange: function handleBuildChange(build) {
	        this.setState({
	            build: build
	        }, this.checkParams);
	    },
	    checkParams: function checkParams() {
	        if (this.state.city_id != 0 || this.state.region_id != 0 || this.state.street_id != 0 || this.state.address_id) {
	            this.setState({
	                can_search: true
	            });
	        } else {
	    ...
	    pageChange: function pageChange(new_page) {
	        this.setState({ page: new_page }, this.loadData);
	    },
	    ...
	    onRow: function onRow(row, _ref2) {
	        ...
	        var rowClass = classNames(row.address_id == this.curRegId ? this.curClass : this.curClass == 'odd-row' ? 'even-row' : 'odd-row', { 'selected-row': row.selected });
	    ...
	    render: function render() {
	        ...
	        var build_table = null;
	        if (this.state.data.length > 0) {
	            build_table = React.createElement(
	                'div',
	                { className: 'box' },
	                React.createElement(
	                    'div',
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            'a',
	                            { href: '/inventory/buildings/export?city=' + this.state.city + '&region=' + this.state.region + '&street=' + this.state.street + '&build=' + this.state.build },
	                    ...
	                    React.createElement(
	                        ...
	                        { name: 'on_page',
	                            ...
	                            onChange: function onChange(e) {
	                                _this.setState({ on_page: e.target.value, page: 1 }, _this.loadData);
	                            } },
	                        React.createElement(
	                            'option',
	                            { value: 10 },
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        'div',
	                        { className: 'build inputrow' },
	                        React.createElement(
	                            'label',
	                            null,
	                            'ID \u0434\u043E\u043C\u0430:'
	                        ),
	                        React.createElement('input', { type: 'text', value: this.state.address_id, onChange: this.handleAddrIdChange })
	                    ),
	                    React.createElement(AddressSelector, {
	            ...
	            build_table,
	            React.createElement(LoadBar, null)
	        );
	    }
	});

	ReactDOM.render(React.createElement(BuildList, null), document.getElementById('build_list'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CitySelect = React.createClass({
	    ...
	    makeCityList: function makeCityList(data) {
	        var cities = [];
	    ...
	    updateCityData: function updateCityData() {
	        $.ajax({
	            type: 'GET',
	    ...
	    handlerCityChange: function handlerCityChange(e) {
	    ...
	    render: function render() {
	        if (this.props.rights) {
	            var field = React.createElement(
	                'select',
	                { onChange: this.handlerCityChange, value: this.props.city_id },
	                this.state.cities
	            );
	        } else {
	            var field = React.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RegionSelect = React.createClass({
	    ...
	    updateRegionData: function updateRegionData(_city_id) {
	        var city_id = _city_id || this.props.city_id;
	        if (city_id != 0) {
	            $.ajax({
	                type: 'GET',
	    ...
	    render: function render() {
	        ...
	        if (this.props.rights) {
	            var field = React.createElement(
	                'select',
	                { onChange: this.onChange, value: this.props.region_id },
	                this.state.regions
	            );
	        } else {
	            var field = React.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StreetSelect = React.createClass({
	    ...
	    streetDataReceived: function streetDataReceived(data) {
	        this.setState({
	            streets: data,
	            loading: false
	        });
	    },
	    loadStreets: function loadStreets(value) {
	        value = value || '';
	        $.ajax({
	            beforeSend: function beforeSend(request) {
	                return request.setRequestHeader('X-CSRF-Token', $("meta[name='csrf-token']").attr('content'));
	    ...
	    streetChange: function streetChange(event, value) {
	    ...
	    checkRegion: function checkRegion() {
	        if (this.props.region_id == 0 && !(this.props.city_id && this.props.skip_region)) {
	            ...
	            this.setState({ mode: 1 }, this.loadStreets);
	        }
	    },
	    componentWillReceiveProps: function componentWillReceiveProps(nextProps) {
	    ...
	    handleStreetSelect: function handleStreetSelect(e, value) {
	        var index = e.nativeEvent.target.selectedIndex;
	        var street_id = e.target.value;
	        var street = e.nativeEvent.target[index].text;
	        this.setState({
	            street_id: street_id,
	    ...
	    render: function render() {
	        ...
	        if (this.props.fixModal) {
	            var ac = $("streets-autocomplete-modal");
	            if (ac) {
	        ...
	        if (this.props.rights) {
	            if (this.state.mode) {
	                ...
	                for (var i = 0; i < this.state.streets.length; i++) {
	                    ...
	                    street_list.push(React.createElement(
	                        'option',
	                        { key: i + 1, value: option.key },
	                        option.value
	                    ));
	                }
	                field = React.createElement(
	                    ...
	                    React.createElement(
	                        'select',
	                        { value: this.state.street_id, onChange: this.handleStreetSelect },
	                        street_list
	                    ),
	                    React.createElement(
	                        'i',
	                        { className: 'icon fa fa-pencil-square-o', onClick: this.handleModeChange },
	                        '\xA0'
	                    )
	                );
	            } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BuildSelect = React.createClass({
	    displayName: 'BuildSelect',

	    getInitialState: function getInitialState() {
	        var builds = [];
	        builds.push(React.createElement(
	            'option',
	            { key: 0, id: 0, value: 0 },
	            '\u041D\u0435 \u0432\u044B\u0431\u0440\u0430\u043D'
	        ));
	    ...
	    makeBuildList: function makeBuildList(data) {
	        data = data.builds;
	        var builds = [];
	        builds.push(React.createElement(
	            'option',
	        ...
	        for (var i = 0; i < data.length; i++) {
	            ...
	            builds.push(React.createElement(
	                'option',
	                { key: i + 1, value: option.address + '-' + option.construction_type },
	                option.home
	            ));
	        }
	        this.setState({
	    ...
	    updateBuildData: function updateBuildData(_street_id, _region_id) {
	        var street_id = _street_id || this.props.street_id || 0;
	        var region_id = _region_id || this.props.region_id || 0;
	        var consType = this.props.consType || 0;
	    ...
	    handlerAddressChange: function handlerAddressChange(e) {
	        var build = e.target.value.split('-');
	        if (typeof this.props.onChange != 'undefined') {
	            var build_info = { id: build[0], construction_type: build[1] };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StreetSelect = __webpack_require__(747);
	var BuildSelect = __webpack_require__(753);
	var BuildString = __webpack_require__(755);
	...
	var Inbuild = React.createClass({
	    ...
	    apartmentChange: function apartmentChange(e) {
	        this.props.apartmentChange(e.target.value);
	    },
	    render: function render() {
	        if (this.props.address_id == 0 && this.props.build == '' || this.state.accuracy == 0) return null;
	        if (this.props.rights || this.props.search) {
	            var entr_field = React.createElement('input', { name: 'entrance', type: 'text', value: this.props.entrance, onChange: this.entranceChange });
	            var floor_field = React.createElement('input', { name: 'floor', type: 'text', value: this.props.floor, onChange: this.floorChange });
	            var apartment_field = React.createElement('input', { name: 'apartment', type: 'text', value: this.props.apartment, onChange: this.apartmentChange });
	        } else {
	            var entr_field = React.createElement(
	                'b',
	                null,
	                this.props.entrance
	            );
	            var floor_field = React.createElement(
	                'b',
	                null,
	                this.props.floor
	            );
	            var apartment_field = React.createElement(
	                'b',
	                null,
	        ...
	        if (this.state.accuracy > 3) {
	            appartment = React.createElement(
	                'div',
	                { className: this.props.className },
	                React.createElement(
	                    'label',
	...
	var AddressSelector = React.createClass({
	    ...
	    applyAddressRights: function applyAddressRights(r) {
	        this.setState({ rights: r });
	    },
	    checkRights: function checkRights() {
	        $.ajax({
	            type: 'GET',
	    ...
	    initAddressInfo: function initAddressInfo(data) {
	        if (data.error == 0) {
	            this.setState({
	    ...
	    updateAddressId: function updateAddressId(address_id) {
	        if (address_id) {
	            $.ajax({
	    ...
	    AddressIdChange: function AddressIdChange(address) {
	        console.log(address);
	        this.setState({
	    ...
	    BuildChange: function BuildChange(build) {
	        var info = build;
	        this.setState({
	            build: build,
	            entrance: ''
	    ...
	    entranceChange: function entranceChange(entrance) {
	        this.setState({ entrance: entrance }, this.AddressChange);
	    },
	    floorChange: function floorChange(floor) {
	        this.setState({ floor: floor }, this.AddressChange);
	    },
	    apartmentChange: function apartmentChange(apartment) {
	        this.setState({ apartment: apartment }, this.AddressChange);
	    },
	    render: function render() {
	        var address_class = classNames('build', 'inputrow', { 'changed': this.props.state == 1 }, { 'cansave': this.props.state == 2 }, { 'saved': this.props.state == 3 }, { 'error': this.props.state == -1 });
	        var build = null;
	        if (this.state.accuracy > 0) {
	            if (!this.state.search) {
	                build = React.createElement(BuildSelect, {
	                    region_id: this.state.region_id,
	                    street_id: this.state.street_id,
	                ...
	                build = React.createElement(BuildString, {
	                    build: this.state.build,
	                    street_id: this.state.street_id,
	                    className: address_class,
	        ...
	        var region = null;
	        if ((typeof this.props.skip_region == 'undefined' || !this.props.skip_region) && !this.props.onlyStreet) {
	            region = React.createElement(RegionSelect, {
	                city_id: this.state.city_id,
	                region: this.state.region,
	                region_id: this.state.region_id,
	                className: address_class,
	        ...
	        return React.createElement(
	            ...
	            !this.props.onlyStreet ? React.createElement(CitySelect, {
	                city_id: this.state.city_id,
	                city: this.state.city,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BuildString = React.createClass({
	    ...
	    handleChange: function handleChange(e) {
	        if (_typeof(this.props.onChange)) {
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            ...
	            React.createElement('input', { value: this.props.build, onChange: this.handleChange })
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Pagination = React.createClass({
	    ...
	    toLast: function toLast() {
	        var total_pages = parseInt(this.props.rows / this.props.on_page);
